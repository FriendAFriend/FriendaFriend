        ...
        <div className="">
          ...
          <div className="">
            ...
            <div className="">
              ...
              <select className="">
                  <option value={listing.pending_status} name="pending_status" onChange={handleChange}>Available</option>
                  <option value={listing.pending_status} name="pending_status"onChange={handleChange}>Pending</option>
                  <option value={listing.pending_status} name="pending_status" onChange={handleChange}>Booked</option>
                
              </select>
              {submitted && (!listing.end_date || !listing.start_date || !listing.city || !listing.photo.length || !listing.pending_status || !listing.description ) && (
